...
<section class="hero hero--research">
  <div class="hero-overlay hero-overlay--clear">
      ...
      <div class="hero-overlay consulting-box">
        ...
        <article class="research-card--hero">
          <div class="research-text">
            <h3 class="research-title">Storm surge modelling along European coastlines</h3>
        ...
        <article class="research-card--hero research-spaced">
          <div class="research-text">
            <h3 class="research-title">Mediterranean seagrasses provide essential coastal protection</h3>
            <p class="research-desc">
